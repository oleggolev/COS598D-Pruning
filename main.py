...
if __name__ == '__main__':
    ...
    parser.add_argument('--result-dir', type=str, default='/scratch/network/vikashm/Results/data/run2',
                        help='path to directory to save results (default: "/scratch/network/vikashm/Results/data")')
